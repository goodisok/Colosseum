...
# -*- coding: utf-8 -*-
"""
1920x1080 源，JPEG 压缩，发布 ROS2 CompressedImage。零 Python 端缩放。
"""
import os
import sys
import time
...
class AirSimCamera1080pPublisher(Node):
    def __init__(self, vehicle_name="PX4_1", camera_name="WideAngleCamera", topic="/camera/color/image_raw/compressed",
        ...
        super().__init__("airsim_camera_1080p_publisher")
...
def main(args=None):
    ...
    node = AirSimCamera1080pPublisher()
    try:
        rclpy.spin(node)
