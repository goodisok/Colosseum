...
# -*- coding: utf-8 -*-
"""
1920x1080 源，JPEG 拉流后解码，发布 ROS2 sensor_msgs/Image（原始像素）。
"""
import os
import sys
import time
...
def main(args=None):
    ...
    node = AirSimCamera1080pRawPublisher()
    try:
        rclpy.spin(node)
