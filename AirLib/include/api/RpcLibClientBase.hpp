...
namespace airlib
{
    ...
    public:
        ...
        vector<EncodedImageCaptureBase::EncodedImageResponse> simGetImagesEncoded(
            vector<EncodedImageCaptureBase::EncodedImageRequest> request, const std::string& vehicle_name = "", bool external = false);
